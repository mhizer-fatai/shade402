...
class _Either_1 {
  alignment() {
    return _descriptor_1.alignment().concat(_descriptor_15.alignment().concat(_descriptor_4.alignment()));
  }
  fromValue(value_0) {
    return {
      is_left: _descriptor_1.fromValue(value_0),
  ...
  toValue(value_0) {
    return _descriptor_1.toValue(value_0.is_left).concat(_descriptor_15.toValue(value_0.left).concat(_descriptor_4.toValue(value_0.right)));
  }
}
...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    if (typeof(witnesses_0.policyBalance) !== 'function') {
      throw new __compactRuntime.CompactError('first (witnesses) argument to Contract constructor does not contain a function-valued field named policyBalance');
    }
    ...
    if (typeof(witnesses_0.policySpentInPeriod) !== 'function') {
      throw new __compactRuntime.CompactError('first (witnesses) argument to Contract constructor does not contain a function-valued field named policySpentInPeriod');
    }
    if (typeof(witnesses_0.policyPerPaymentLimit) !== 'function') {
      throw new __compactRuntime.CompactError('first (witnesses) argument to Contract constructor does not contain a function-valued field named policyPerPaymentLimit');
    }
      ...
      registerAgent: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('registerAgent',
                                     ...
                                     'shade402.compact line 94 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const partialProofData = {
          input: {
            value: _descriptor_5.toValue(dailyLimit_0).concat(_descriptor_5.toValue(perPaymentLimit_0)),
      ...
      allowProvider: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('allowProvider',
                                     'argument 1 (as invoked from Typescript)',
                                     'shade402.compact line 110 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const partialProofData = {
          input: {
            value: _descriptor_4.toValue(provider_0),
      ...
      revokeProvider: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('revokeProvider',
                                     'argument 1 (as invoked from Typescript)',
                                     'shade402.compact line 117 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(typeof(provider_0) === 'object' && provider_0.bytes.buffer instanceof ArrayBuffer && provider_0.bytes.BYTES_PER_ELEMENT === 1 && provider_0.bytes.length === 32)) {
      ...
      deposit: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('deposit',
                                     'argument 1 (as invoked from Typescript)',
                                     'shade402.compact line 127 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
      ...
      withdraw: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('withdraw',
                                     'argument 1 (as invoked from Typescript)',
                                     'shade402.compact line 135 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(typeof(amount_0) === 'bigint' && amount_0 >= 0n && amount_0 <= 18446744073709551615n)) {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_5.toValue(amount_0).concat(_descriptor_4.toValue(destination_0)),
      ...
      payInvoice: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('payInvoice',
                                     'argument 1 (as invoked from Typescript)',
                                     'shade402.compact line 150 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const partialProofData = {
          input: {
            value: _descriptor_4.toValue(recipient_0).concat(_descriptor_0.toValue(invoiceHash_0).concat(_descriptor_5.toValue(amount_0))),
            alignment: _descriptor_4.alignment().concat(_descriptor_0.alignment().concat(_descriptor_5.alignment()))
          },
          output: undefined,
          publicTranscript: [],
          privateTranscriptOutputs: []
    ...
    return _descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                     ...
                                                                     [
                                                                      ...
                                                                      { idx: { cached: true,
                                                                               ...
                                                                               path: [
                                                                                      { tag: 'value',
                                                                                        value: { value: _descriptor_14.toValue(tmp_0),
                                                                                                 alignment: _descriptor_14.alignment() } }] } },
                                                                      { push: { storage: false,
                                                                                value: __compactRuntime.StateValue.newCell({ value: _descriptor_12.toValue(amount_0),
                                                                                                                             alignment: _descriptor_12.alignment() }).encode() } },
  ...
  _localSecret_0(context, partialProofData) {
    ...
    if (!(result_0.buffer instanceof ArrayBuffer && result_0.BYTES_PER_ELEMENT === 1 && result_0.length === 32)) {
      __compactRuntime.typeError('localSecret',
                                 'return value',
                                 'shade402.compact line 53 char 1',
                                 'Bytes<32>',
                                 result_0)
    }
  ...
  _agentSecret_0(context, partialProofData) {
    ...
    if (!(result_0.buffer instanceof ArrayBuffer && result_0.BYTES_PER_ELEMENT === 1 && result_0.length === 32)) {
      __compactRuntime.typeError('agentSecret',
                                 'return value',
                                 'shade402.compact line 54 char 1',
                                 'Bytes<32>',
                                 result_0)
    }
    partialProofData.privateTranscriptOutputs.push({
  ...
  _agentPath_0(context, partialProofData) {
    ...
    if (!(typeof(result_0) === 'object' && result_0.leaf.buffer instanceof ArrayBuffer && result_0.leaf.BYTES_PER_ELEMENT === 1 && result_0.leaf.length === 32 && Array.isArray(result_0.path) && result_0.path.length === 16 && result_0.path.every((t) => typeof(t) === 'object' && typeof(t.sibling) === 'object' && typeof(t.sibling.field) === 'bigint' && t.sibling.field >= 0 && t.sibling.field <= __compactRuntime.MAX_FIELD && typeof(t.goes_left) === 'boolean'))) {
      __compactRuntime.typeError('agentPath',
                                 'return value',
                                 'shade402.compact line 55 char 1',
  ...
  _policyBalance_0(context, partialProofData) {
    const witnessContext_0 = __compactRuntime.createWitnessContext(ledger(context.currentQueryContext.state), context.currentPrivateState, context.currentQueryContext.address);
    const [nextPrivateState_0, result_0] = this.witnesses.policyBalance(witnessContext_0);
    context.currentPrivateState = nextPrivateState_0;
    if (!(typeof(result_0) === 'bigint' && result_0 >= 0n && result_0 <= 18446744073709551615n)) {
      __compactRuntime.typeError('policyBalance',
                                 'return value',
                                 'shade402.compact line 56 char 1',
                                 'Uint<0..18446744073709551616>',
                                 result_0)
    }
    partialProofData.privateTranscriptOutputs.push({
  ...
  _policyDailyLimit_0(context, partialProofData) {
    ...
    if (!(typeof(result_0) === 'bigint' && result_0 >= 0n && result_0 <= 18446744073709551615n)) {
      __compactRuntime.typeError('policyDailyLimit',
                                 'return value',
                                 'shade402.compact line 57 char 1',
                                 'Uint<0..18446744073709551616>',
                                 result_0)
    }
    partialProofData.privateTranscriptOutputs.push({
  ...
  _policySpentInPeriod_0(context, partialProofData) {
    const witnessContext_0 = __compactRuntime.createWitnessContext(ledger(context.currentQueryContext.state), context.currentPrivateState, context.currentQueryContext.address);
    const [nextPrivateState_0, result_0] = this.witnesses.policySpentInPeriod(witnessContext_0);
    context.currentPrivateState = nextPrivateState_0;
    if (!(typeof(result_0) === 'bigint' && result_0 >= 0n && result_0 <= 18446744073709551615n)) {
      __compactRuntime.typeError('policySpentInPeriod',
                                 'return value',
                                 'shade402.compact line 58 char 1',
                                 'Uint<0..18446744073709551616>',
                                 result_0)
    }
    partialProofData.privateTranscriptOutputs.push({
  ...
  _policyPerPaymentLimit_0(context, partialProofData) {
    const witnessContext_0 = __compactRuntime.createWitnessContext(ledger(context.currentQueryContext.state), context.currentPrivateState, context.currentQueryContext.address);
    const [nextPrivateState_0, result_0] = this.witnesses.policyPerPaymentLimit(witnessContext_0);
    context.currentPrivateState = nextPrivateState_0;
    if (!(typeof(result_0) === 'bigint' && result_0 >= 0n && result_0 <= 18446744073709551615n)) {
      __compactRuntime.typeError('policyPerPaymentLimit',
                                 'return value',
                                 'shade402.compact line 59 char 1',
                                 'Uint<0..18446744073709551616>',
                                 result_0)
    }
    partialProofData.privateTranscriptOutputs.push({
  ...
  _registerAgent_0(context, partialProofData, dailyLimit_0, perPaymentLimit_0) {
                                                                                                 ...
                                                                                                 path: [
                                                                                                        { tag: 'value',
                                                                                                          value: { value: _descriptor_17.toValue(2n),
                                                                                                                   alignment: _descriptor_17.alignment() } }] } },
                                                                                        { push: { storage: false,
                                                                                                  value: __compactRuntime.StateValue.newCell({ value: _descriptor_4.toValue(provider_0),
  ...
  _deposit_0(context, partialProofData, amount_0) {
    ...
    const tmp_0 = ((t1) => {
                    if (t1 > 18446744073709551615n) {
                      throw new __compactRuntime.CompactError('shade402.compact line 130 char 22: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 18446744073709551615');
                    }
                    return t1;
  ...
  _payInvoice_0(context, partialProofData, recipient_0, invoiceHash_0, amount_0)
  {
    ...
    const computed_root_0 = this._merkleTreePathRoot_0(path_0);
    __compactRuntime.assert(_descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
                                                                                      [
                                                                                       { dup: { n: 0 } },
                                                                                                ...
                                                                                                path: [
                                                                                                       { tag: 'value',
                                                                                                         value: { value: _descriptor_17.toValue(2n),
                                                                                                                  alignment: _descriptor_17.alignment() } }] } },
                                                                                       { push: { storage: false,
                                                                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_3.toValue(computed_root_0),
                                                                                                ...
                                                                                                path: [
                                                                                                       { tag: 'value',
                                                                                                         value: { value: _descriptor_17.toValue(2n),
                                                                                                                  alignment: _descriptor_17.alignment() } }] } },
                                                                                       { push: { storage: false,
                                                                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_4.toValue(recipient_0),
                                                                                                                                              alignment: _descriptor_4.alignment() }).encode() } },
                                                                                       'member',
                                                                                       { popeq: { cached: true,
                                                                                                  result: undefined } }]).value),
    ...
    const balance_0 = this._policyBalance_0(context, partialProofData);
    const dailyLimit_0 = this._policyDailyLimit_0(context, partialProofData);
    const spent_0 = this._policySpentInPeriod_0(context, partialProofData);
    const perPaymentLimit_0 = this._policyPerPaymentLimit_0(context,
                                                            partialProofData);
    __compactRuntime.assert(balance_0 >= amount_0, 'Insufficient agent balance');
    __compactRuntime.assert(perPaymentLimit_0 >= amount_0,
                            'Payment exceeds per-payment limit');
    let t_0;
    __compactRuntime.assert((t_0 = spent_0 + amount_0, t_0 <= dailyLimit_0),
    ...
    const tmp_0 = ((t1) => {
                    if (t1 > 18446744073709551615n) {
                      throw new __compactRuntime.CompactError('shade402.compact line 193 char 26: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 18446744073709551615');
                    }
                    return t1;
                  })(_descriptor_5.fromValue(__compactRuntime.queryLedgerState(context,
                                                                               partialProofData,
      ...
      checkRoot(...args_0) {
        ...
        if (!(typeof(rt_0) === 'object' && typeof(rt_0.field) === 'bigint' && rt_0.field >= 0 && rt_0.field <= __compactRuntime.MAX_FIELD)) {
          __compactRuntime.typeError('checkRoot',
                                     'argument 1',
                                     'shade402.compact line 30 char 1',
      ...
      member(...args_0) {
        ...
        if (!(elem_0.buffer instanceof ArrayBuffer && elem_0.BYTES_PER_ELEMENT === 1 && elem_0.length === 32)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'shade402.compact line 31 char 1',
                                     'Bytes<32>',
                                     elem_0)
        }
        return _descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
    ...
    allowedProviders: {
      ...
      member(...args_0) {
        ...
        if (!(typeof(elem_0) === 'object' && elem_0.bytes.buffer instanceof ArrayBuffer && elem_0.bytes.BYTES_PER_ELEMENT === 1 && elem_0.bytes.length === 32)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'shade402.compact line 32 char 1',
                                     'struct UserAddress<bytes: Bytes<32>>',
                                     elem_0)
        }
        return _descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
...
const _dummyContract = new Contract({
  ...
  policyBalance: (...args) => undefined,
  policyDailyLimit: (...args) => undefined,
  policySpentInPeriod: (...args) => undefined,
  policyPerPaymentLimit: (...args) => undefined
});
