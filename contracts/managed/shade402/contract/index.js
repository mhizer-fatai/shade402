...
class _AgentPolicy_0 {
  alignment() {
    return _descriptor_1.alignment().concat(_descriptor_1.alignment().concat(_descriptor_1.alignment().concat(_descriptor_1.alignment().concat(_descriptor_1.alignment()))));
  }
  fromValue(value_0) {
    return {
      balance: _descriptor_1.fromValue(value_0),
      dailyLimit: _descriptor_1.fromValue(value_0),
      spentInPeriod: _descriptor_1.fromValue(value_0),
      periodEndsAt: _descriptor_1.fromValue(value_0),
      perPaymentLimit: _descriptor_1.fromValue(value_0)
    }
  }
  toValue(value_0) {
    return _descriptor_1.toValue(value_0.balance).concat(_descriptor_1.toValue(value_0.dailyLimit).concat(_descriptor_1.toValue(value_0.spentInPeriod).concat(_descriptor_1.toValue(value_0.periodEndsAt).concat(_descriptor_1.toValue(value_0.perPaymentLimit)))));
  }
}

const _descriptor_2 = new _AgentPolicy_0();
...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      registerAgent: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('registerAgent',
                                     ...
                                     'shade402.compact line 42 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const partialProofData = {
          input: {
            value: _descriptor_1.toValue(dailyLimit_0).concat(_descriptor_1.toValue(perPaymentLimit_0).concat(_descriptor_1.toValue(periodEndsAt_0))),
      ...
      payInvoice: (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_4.toValue(recipient_0).concat(_descriptor_0.toValue(invoiceHash_0).concat(_descriptor_1.toValue(amount_0))),
            alignment: _descriptor_4.alignment().concat(_descriptor_0.alignment().concat(_descriptor_1.alignment()))
          },
          output: undefined,
          publicTranscript: [],
          privateTranscriptOutputs: []
  ...
  _localSecret_0(context, partialProofData) {
    ...
    if (!(result_0.buffer instanceof ArrayBuffer && result_0.BYTES_PER_ELEMENT === 1 && result_0.length === 32)) {
      __compactRuntime.typeError('localSecret',
                                 'return value',
                                 'shade402.compact line 19 char 1',
                                 'Bytes<32>',
                                 result_0)
    }
    ...
    if (this._blockTimeGte_0(context, partialProofData, account_0.periodEndsAt))
    {
      return ((t1) => {
               if (t1 > 18446744073709551615n) {
                 throw new __compactRuntime.CompactError('shade402.compact line 37 char 16: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 18446744073709551615');
               }
               return t1;
  ...
  _deposit_0(context, partialProofData, amount_0) {
    ...
    const account_0 = _descriptor_2.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                partialProofData,
                                                                                [
                                                                                 { dup: { n: 0 } },
                                                                                 { idx: { cached: false,
    ...
    const tmp_0 = { balance:
                      ((t1) => {
                        if (t1 > 18446744073709551615n) {
                          throw new __compactRuntime.CompactError('shade402.compact line 71 char 27: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 18446744073709551615');
                        }
                        return t1;
    ...
    const tmp_1 = ((t1) => {
                    if (t1 > 18446744073709551615n) {
                      throw new __compactRuntime.CompactError('shade402.compact line 77 char 22: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 18446744073709551615');
                    }
                    return t1;
  ...
  _payInvoice_0(context, partialProofData, recipient_0, invoiceHash_0, amount_0)
  {
    ...
    const tmp_0 = { balance:
                    ...
                    spentInPeriod:
                      ((t1) => {
                        if (t1 > 18446744073709551615n) {
                          throw new __compactRuntime.CompactError('shade402.compact line 107 char 33: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 18446744073709551615');
                        }
                        return t1;
    ...
    const tmp_1 = ((t1) => {
                    if (t1 > 18446744073709551615n) {
                      throw new __compactRuntime.CompactError('shade402.compact line 114 char 26: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 18446744073709551615');
                    }
                    return t1;
                  })(_descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                               partialProofData,
